About earthengine-api-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/earthengine-api-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/earthengine-api-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add earthengine-api
# for installing globally
pixi global install earthengine-api
```
...
It is possible to list all of the versions of `earthengine-api` available on your platform:
...
```
pixi search earthengine-api --channel conda-forge
```
